...
def get_session_key(url, p):
    return requests.get(login_url, params=param_objects).text  # функция получения ключа сессии



# параметры необходимые для работы скрипта

database_connection = ['10.10.4.4', 'sa', 'qwEr12#4', "dozor_2023_07_29"]  # параметры коннекта к базе данных
user = 'CCT'
usr_pass = '200318'
